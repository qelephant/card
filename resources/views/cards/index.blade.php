            ...
            <div class="card-body">
                ...
                @if (count($card['lessons']) > 0)
                    ...
                    <div class="d-flex flex-row m-3">
                        ...
                        <div class="col-md-8">
                            <div class="btn-group">
                                <a href="" class="btn btn-info" alt="Просмотр"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                @if ($card['method'][$key]['id'] == '1')
                                    <p></p>
                                @else
                                <a href="#" class="list-group-item list-group-item-action" data-toggle="modal" data-target="#exampleModalCenter{{$card['method'][$key]['name']}}{{$card['method'][$key]['id']}}">{{$card['method'][$key]['name']}}</a>
                                    <div class="modal fade" id="exampleModalCenter{{$card['method'][$key]['name']}}{{$card['method'][$key]['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><b>Необходимые ресурсы</b> {{$card['method'][$key]['required_resources']}}
                                                <p><b>Рекомендуемый этап урока</b> {{$card['method'][$key]['recommended_stage']}}
                                            </div>
                            ...
                            <td>
                                <a href="#" class="list-group-item list-group-item-action" data-toggle="modal" data-target="#exampleModalCenter{{$card['feedback'][$key]['name']}}{{$card['feedback'][$key]['id']}}">{{$card['feedback'][$key]['name']}}</a>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalCenter{{$card['feedback'][$key]['name']}}{{$card['feedback'][$key]['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Title</h5>
                            ...
                            <td colspan="2">
                                <a class="list-group-item list-group-item-action">{{$card['questions'][$key]['name']}}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
