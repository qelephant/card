    ...
    <div class="row">
        <div class="card-body">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p><b>Метод: </b> {{ $card['method'][$key]['name'] }}</p>
                            <p><b>Форма обратной связи:</b> {{$card['feedback'][$key]['name']}}</p>
                            <textarea data-user="" name="start_lesson_comments{{$key+1}}" class="form-control" placeholder="Введите комментарий" style="height: 49px;"></textarea>
                            <br><br>
                            <p><b>Полезные вопросы на уроке:</b> {{$card['questions'][$key]['name']}}</p>
                        </td>
                        <td>
                            <textarea data-user="" name="start_lesson_resource{{$key+1}}" class="form-control" rows="10" cols="70" placeholder="Введите ресурсы"></textarea>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            <div class="container mt-3 mb-3">
                ...
                <div class="col-md-8"><textarea data-user="" class="form-control" name="reflection"></textarea></div>
            </div>
            </div>
            </div>
        </div>
